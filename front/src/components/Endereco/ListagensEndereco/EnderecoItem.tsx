...
export default function EnderecoItem({ endereco, onDelete, isSelected, onSelect, onEdit }: EnderecoItemProps) {
  ...
  return (
    <div
      className={`relative rounded-md border-2 p-4 hover:border-brown-normal ${isSelected ? 'border-red-500' : 'border-gray-300'
        } cursor-pointer`}
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-3">
          {endereco.tipo === "casa" ? (
            <FaHome className="text-blue text-2x1 w-6 h-6" />
