...
import { usePagamento } from "@/pages/Usuario/hooks/Pagamento/usePagamento";
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 xl:flex-row">
      <div className="card border-gray-light m-auto mt-[5rem] border p-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="my-4 flex w-full items-center justify-between gap-4">
              <div>
                ...
                <p className="w-80 break-words">{endereco.complemento}</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-5 flex gap-5">
          <div
            ...
            className={`w-full cursor-pointer rounded-lg border-2 p-4 ${
              taxaEntregaSelecionada === taxaEntregaPadrao
          ...
          <div
            ...
            className={`w-full cursor-pointer rounded-lg border-2 p-4 ${
              taxaEntregaSelecionada === taxaEntregaRapida
                ? "border-brown-normal text-brown-dark"
                : "border-gray-300"
            }`}
          >
        ...
        <hr className="text-gray-light mt-6 mb-2" />
        <div>
      ...
      >
        ...
        <p className="mt-10 flex items-center justify-between gap-8 font-bold">
          Total
          <span>R$ {valoresCarrinho.total.toFixed(2)}</span>
        </p>
      </div>
    </div>
  );
